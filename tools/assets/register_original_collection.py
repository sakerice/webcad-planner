...
for source in ['original-collection.json','exterior-collection.json','entry-storage-collection.json','sanitary-collection.json','essentials-collection.json','doors-collection.json','garden-collection.json','decor-collection.json']:
