...
room("洋室", 0, 3640, 2730, 4550, 1, texture="wood_oak")
...
room("LDK", 0, 2730, 3640, 3640, 2, texture="wood_oak")
room("LDK", 3640, 3640, 1820, 3640, 2, texture="wood_oak")
room("収納", 3640, 7280, 1820, 910, 2, texture="wood_oak")
# 吹き抜け。天井高は書かない -- toFloor だけ宣言すればアプリが階高から計算する。
# 手で数字を書くと階高を変えた瞬間に上階の天井と食い違う
room("リビング", 0, 6370, 3640, 1820, 2, texture="wood_oak",
...
room("洋室A", 0, 0, 2730, 2730, 3, texture="wood_oak")
room("クローゼット", 2730, 0, 910, 2730, 3, texture="wood_oak")
room("ホール", 3640, 0, 910, 3640, 3, texture="wood_oak")
room("廊下", 0, 2730, 3640, 910, 3, texture="wood_oak")
room("主寝室", 0, 3640, 2730, 2730, 3, texture="wood_oak")
room("WIC", 2730, 3640, 910, 2730, 3, texture="wood_oak")
room("洋室B", 3640, 3640, 1820, 3640, 3, texture="wood_oak")
room("クローゼット", 3640, 7280, 1820, 910, 3, texture="wood_oak")
