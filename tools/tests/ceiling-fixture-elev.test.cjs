...
const FNS = [
  ...
  'baseRoomOf', 'floorRoomIgnoringSkip', 'roomsAtPointOnFloor', 'roomAtPointOnFloor', 'usesFinishedHeightModel', 'ceilingFinishThicknessM',
  'roomCeilingElevationMm', 'ceilingFinishElevationMm', 'defaultLightElevationMm',
