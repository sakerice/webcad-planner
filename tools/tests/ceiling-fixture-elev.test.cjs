...
const FNS = [
  ...
  'floorSlabMmForFloor', 'localSupportTopY', 'floorHasSkipLevel', 'wallSkipBaseMm', 'segmentInsideRectLengthMm',
  ...
  'roomAtPointOnFloor', 'roomCeilingElevationMm', 'ceilingFinishElevationMm', 'defaultLightElevationMm',
