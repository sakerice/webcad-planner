...
function drawLabelsOn(data, floor) {
  ...
  const c = sandbox([
    ...
    topLevelFunction('wallSkipBaseMm', 'wallSkipLevelsMm', 'wallSkipFootMm', 'floorMaxSkipLevelMm'), topLevelFunction('baseRoomOf', 'floorRoomIgnoringSkip', 'roomsAtPointOnFloor', 'roomAtPointOnFloor'),
    ...
    topLevelFunction('roomCeilingProfile', 'roofsOverRoom'), topLevelFunction('roomCeilingWorldYAtMm', 'roofCeilingOffsetMm'),
