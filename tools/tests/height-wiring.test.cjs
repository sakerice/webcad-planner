...
function ceilingYsFor(data, floor) {
  ...
  const ctx = vm.createContext({
    ...
    THREE: {
      ...
      MeshStandardMaterial: function () { return {userData:{}}; },
...
function ceilingBuilder(data) {
  ...
  vm.runInContext([
    ...
    topLevelFunction('buildSlopedCeilingGeometry'), topLevelFunction('buildSteppedCeilingGrid'), topLevelFunction('stepAwareSamples'), topLevelVar('STEP_JUMP_MIN_M'), topLevelVar('STEP_JUMP_RATIO'),
