...
同じ階の中で床が持ち上がっている区画がある。スキップフロア、和室の小上がり、玄関の上がり框の段など。**床だけでなく天井も一緒に上がる。** 上限は 2400mm。

段差の下は空間になり、そこが収納になっていることがある（「ハーフ収納」
「床上げ収納」「階段下収納」）。**その収納は段差の下にある別の部屋**として
parts に入れ、level は 0 とする。持ち上がっているのは上の区画のほうである。
