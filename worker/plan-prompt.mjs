...
手順6〜15で、壁で囲まれた場所を1つずつ rooms に入れる。範囲は手順5の座標を
用いた長方形で表す。
...
**手順16.** 水まわりの設備（浴槽・便器・洗面台・流し台）を items に入れる。
...
**手順17.** 扉を items に入れる。それぞれ、どの部屋とどの部屋の間にあるかを
特定し、x と y をその2つの部屋が接する境界の上に置く。玄関ドアは、玄関と
建物の外が接する境界の上に置く。

w は、図に描かれている開口の幅とする。

**手順18.** 窓を items に入れる。それぞれ、どの部屋にあるかを特定し、x と y を
...
**手順20.** 階段を見直す。段が向きを変えているのに stair-corner を置いて
いないか、直進部分と離れていないかを確かめ、直す。
${hint ? `\n利用者からの補足: ${hint}\n` : ""}`;
}
