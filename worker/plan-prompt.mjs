...
**手順10.** 階段が描かれている部屋を入れる。name は「階段室」とする。
...
**手順14.** 階段と水まわりの設備（浴槽・便器・洗面台・流し台）を items に入れる。
それぞれ、描かれている部屋を手順6〜13で入れた部屋から特定し、x と y をその部屋の
範囲の中に収める。

**手順15.** 扉を items に入れる。それぞれ、どの部屋とどの部屋の間にあるかを特定し、
x と y をその2つの部屋が接する境界の上に置く。玄関ドアは、玄関と建物の外が
接する境界の上に置く。

**手順16.** 窓を items に入れる。それぞれ、どの部屋にあるかを特定し、x と y を
